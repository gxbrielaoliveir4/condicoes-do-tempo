...
if(!input || !sectionTempoInfo) return
  ...
  try{const resposta = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${localizaçao}&appid=f03a51d816916ca067830d65866f9ecc&lang=pt_br&units=metric`)
